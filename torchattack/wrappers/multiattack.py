...
class MultiAttack(Attack):
    ...
    Examples::
        >>> atk1 = torchattack.PGD(model, eps=8/255, alpha=2/255, iters=40, random_start=True)
        >>> atk2 = torchattack.PGD(model, eps=8/255, alpha=2/255, iters=40, random_start=True)
        >>> atk = torchattack.MultiAttack([atk1, atk2])
