...
def my_checkpoint_filter_fn(state_dict, model, args):
    ...
    _logger.warning(f"down_indicator={down_indicator}")
    for k, v in state_dict.items():
    ...
    if pretrained:
        if pretrained_custom_load:
            ...
            if pretrained_filter_fn is not None:
                ...
                checkpoint_filter_fn = partial(my_checkpoint_filter_fn, args=kwargs.pop('args'), model=model)
            load_pretrained(
                model,
